...
import NSEImage from '../Images/NSEImage.jpg'
  ...
  render() {
      ...
      return (
        ...
        <View style={{flex:2, margin: 5}}>
            ...
            <Text style={styles.copyright}>Version:</Text>
            ...
            <Text style={styles.copyright}> {'\n'}Keep in mind that Diabetes Diary is storing your health dat on your mobile device. Read more </Text>
              <TouchableOpacity onPress={() => Linking.openURL('http://www.google.com')}>
                <Text style={styles.copyright, {textDecorationLine: 'underline', color: '#0837ff'}}>here.</Text>
              </TouchableOpacity>
